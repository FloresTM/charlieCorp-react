  ...
  return (
    <div>
        <div className='cover'>
          ...
          <div className='cover_derecha'>
            <div className='cover_derecha_derecha'>
              <h2 className='nombre_empresa_cover_dos'>Charlie<span className='niva_light'>Corp</span></h2>
            </div>
        ...
        <div className='seccion_equipo'>
          ...
          {/* Se acaba rol */}
          <a className='no_underline' href='/quienes-somos'><button className='miembros_equipo_boton'>Conoce Mas</button></a>
          <p>.</p>
        </div>
        {/* Se acaba seccion */}
        ...
        <div className='sobre_proyecto_seccion'>
          ...
          <div className='sobre_proyecto_row_contenido'>
            ...
            <div className='sobre_proyecto_derecha'>
              ...
              <a className='no_underline' href='/nuestro-proyecto'><button className='sobre_proyecto_boton'>Conoce Mas</button></a>
            </div>
          </div>
          {/* no se en donde va */}
        </div>
